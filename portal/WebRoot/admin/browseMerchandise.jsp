...
<center>
	...
	<div class="displayTable">
		<display:table name="merList" id="row" pagesize="15" export="true" class="displaytag" requestURI="mer_browseMerchandise.action" >
			...
			<display:column property="price" title="物主估价" sortable="true" headerClass="sortable" style="text-align:center;"/>
			<display:column title="几成新" sortable="true" headerClass="sortable" style="text-align:center;">
