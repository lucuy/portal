 ...
 <script language="JavaScript" type="text/javascript">
	...
	function processSelected(menuid){
		...
		if (menuid=='column'){
			...
			url = "loadAllChange.action";		
		}else if(menuid=='message'){
			url = "getAllMessages.action";
		}else if(menuid=='appraise'){
			url = "getAllAppriase.action";
		}else if (menuid=='ip'){
			url = "SelectTopMember.action";		
		}else if (menuid=='pv'){
			url = "SelectTopNews.action";	
...
<s:tree label="<b>易物网后台管理</b>" id="adminctrl" theme="ajax" showRootGrid="true" showGrid="true">
    ...
    <s:treenode theme="ajax" label="<img src='../images/Car.jpg'/>易物管理" id="order_man">
        <s:treenode theme="ajax" label="<img src='../images/icon_order.gif'/>订单管理" id="order"/>
        <s:treenode theme="ajax" label="<img src='../images/edit.gif'/>留言管理" id="message"/>
        <s:treenode theme="ajax" label="<img src='../images/edit.gif'/>评价管理" id="appraise"/>
    </s:treenode>
    <s:treenode theme="ajax" label="<img src='../images/icon_trafic.gif'/>数量统计" id="ip_pv">
        <s:treenode theme="ajax" label="<img src='../images/icon_ip.gif'/>活跃会员" id="ip"/>
        <s:treenode theme="ajax" label="<img src='../images/icon_pv.gif'/>热度新闻" id="pv"/>
    </s:treenode>    
