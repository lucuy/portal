...
public class NewsAction extends ActionSupport implements ModelDriven<News>{
	...
	private String NewsNameList;
	private String clicksList;
	...
	public String SelectTopNews(){
		newsList=service.selectTopTen();
		if(newsList!=null){
			StringBuffer sbf = new StringBuffer();
			StringBuffer sb=new StringBuffer();
			//看监控对象是否可用
			for(News mwt:newsList){
				//mwt.getLoginName();
				sbf.append("'"+mwt.getTitle()+"'"+",");
				sb.append(mwt.getClicks()+",");
			}
			NewsNameList=sbf.toString().substring(0, sbf.toString().length()-1);
			clicksList=sb.toString().substring(0,sb.toString().length()-1);
		}
		return "success";
	}
	...
	public String getNewsNameList() {
		return NewsNameList;
	}

	public void setNewsNameList(String newsNameList) {
		NewsNameList = newsNameList;
	}

	public String getClicksList() {
		return clicksList;
	}

	public void setClicksList(String clicksList) {
