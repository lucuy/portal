...
public class SlidenewsTag extends SimpleTagSupport {
    ...
    public void doTag() throws JspException, IOException{
    	...
    	if (newstype.equals("4")){//所有类型
			hql=" from News as a where a.status=1  and a.isPicNews=1 order by a.priority desc,a.id desc";
		}else{
			hql=" from News as a where a.status=1  and a.newsType="+newstype+" and a.isPicNews=1 order by a.priority desc,a.id desc";
		}
